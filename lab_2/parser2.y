...
//start rule
translation_unit: shader_def interface_vars external_declarations
    | shader_def external_declarations;

interface_vars: interface_var          
    | interface_vars interface_var;
   
interface_method: fully_specified_type IDENTIFIER ';';
...
shader_def: CLASS IDENTIFIER
    |CLASS IDENTIFIER ':' inheritance ';';
    
inheritance: RT_PRIMITIVE
    |RT_CAMERA
    |RT_MATERIAL
    |RT_TEXTURE
    |RT_LIGHT;
